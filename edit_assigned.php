    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_assigned_form.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<thead>
										...
										<tbody>
										<?php
										$class_query = mysqli_query($conn,"select * from costemer c 
										LEFT JOIN employee e ON e.employee_id = c.employee_id
										LEFT JOIN customer co ON co.customer_id = c.customer_id")or die(mysqli_error());
										...
										<tr>
											...
											<td><?php echo $class_row['customer_name']; ?></td>
											<td><?php echo $class_row['firstname']; ?></td>
