   <div class="row-fluid">
       <a href="Employes.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> አዲስ ሰራተኛ አስገባ</a>
                        <!-- block -->
                        <div class="block">
								...
								<form method="post">
										...
										<div class="control-group">የግምገማ ምደባ
                                          ...
                                          <div class="controls">
											...
											<?php
											$cys_query = mysqli_query($conn,"select * from programs where program_id='19'");
											while($cys_row = mysqli_fetch_array($cys_query)){
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input name="fill"  value="<?php echo $row['emplo_id']; ?>"  class="input focused" id="focusedInput" type="text" placeholder = "ፋይል ቁጥር" required>
                                          </div>
                                        </div>
										<div class="control-group">
                                          <div class="controls">
	      ...
	      <?php
                            if (isset($_POST['update'])) {
                                ...
                                $fill = $_POST['fill'];	
                                $emp_ID = $_POST['emp_ID'];								
								mysqli_query($conn,"update employee set emplo_id ='$fill' , firstname ='$fn' , lastname = '$ln' ,middle_name = '$middle' ,gender ='$gender', program_id = '$progr' ,job_title_id ='$jobtitle' ,emp_ID ='$emp_ID' ,password ='$password' where employee_id = '$get_id' ")or die(mysqli_error());
