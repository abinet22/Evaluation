...
<marquee style="color: #eef0f1;
	...
	<p style="font-size:23px;margin:8px;">የሰራተኞች የስራ አፈጻጸም የ360 ዲግሪ የስድስት ወራት መመዘኛ ቅጽ</p>
</marquee>
...
<body id="login" style="padding:1px;">
	<div class="container">
		<form id="login_form" class="form-signin" method="post" style="width:21%;">
			...
			<input type="text" class="input-block-level" id="usernmae" name="empuser" placeholder="Employee ID" placeholder="username">
			<input type="password" class="input-block-level" id="password" name="emppass" placeholder="Employee Password" placeholder="Password">
					...
					$.ajax({
						...
						success: function(html) {
							if (html == 'true') {
								...
								var delay = 2000;
								setTimeout(function() {
									window.location = './employeeevaluation/dashboard.php'
								}, delay);
							} else {
