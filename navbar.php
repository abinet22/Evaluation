<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <span class="brand" href="#">የሰላም ቴክኒክና ሙያ ትምህርትና ስልጠና ኮሌጅ የሰራተኞች የ360 ዲግሪ የግምገማ መረጃ መሰብሰቢያ</span>
                ...
                <ul class="nav pull-right" style="background:#325ea0;">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="change_password.php"><i class="icon-circle"></i> Change Password</a>
                            <li><a tabindex="-1" href="#myModal" data-toggle="modal"><i class="icon-picture"></i> Change ID Photo</a></li>
