       ...
       <a href="Employes.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> አዲስ ሰራተኛ አስገባ</a>
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($conn,"update employee set firstname ='$fn' , lastname = '$ln' ,middle_name = '$middle' ,gender ='$gender', program_id = '$progr' ,job_title_id ='$jobtitle' ,emp_ID ='$emp_ID' ,password='$password' where employee_id = '$get_id' ")or die(mysqli_error());
