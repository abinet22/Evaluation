<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="#">Welcome to: Selam TVET College |LMS|</a>
            <div class="nav-collapse collapse">
                <ul class="nav pull-right" style="background:#325ea0;">
                    <?php $query = mysqli_query($conn, "select * from registerd where registerd_id = '$session_id'") or die(mysqli_error());
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="change_password_employee.php"><i class="icon-circle"></i> Change Password</a></li>
