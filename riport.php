...
top: opx;}
								...
								<?php
									...
									<?php 
										 ...
										 <?php
											...
											where e.emplo_id = '$get_id' AND e.program_id = 19 order by e.employee_result_id desc limit 1
											") or die(mysqli_error());
											while ($row = mysqli_fetch_array($content_query)) {
									...
									<?php } 
										?>
										  <?php
											$total_score = 0;
											$content_query = mysqli_query($conn, "select * from employee_result e
											where e.emplo_id = '$get_id' AND e.program_id = 20 order by e.employee_result_id desc limit 1
											") or die(mysqli_error());
											while ($row = mysqli_fetch_array($content_query)) {
												$total_result_point +=$row['result_point'];
												$total_result_wate +=$row['stated'];
									...
									<?php } 
										?>
										  <?php
											$total_score = 0;
											$content_query = mysqli_query($conn, "select * from employee_result e
											where e.emplo_id = '$get_id' AND e.program_id = 21 order by e.employee_result_id desc limit 1
											") or die(mysqli_error());
											while ($row = mysqli_fetch_array($content_query)) {
												$total_result_point +=$row['result_point'];
												$total_result_wate +=$row['stated'];
									...
									<?php } 
										?>
										  <?php
											$total_score = 0;
											$content_query = mysqli_query($conn, "select * from employee_result e
											where e.emplo_id = '$get_id' AND e.program_id = 22 order by e.employee_result_id desc limit 1
											") or die(mysqli_error());
											while ($row = mysqli_fetch_array($content_query)) {
												$total_result_point +=$row['result_point'];
												$total_result_wate +=$row['stated'];
									...
									<?php } 
										?>
										   <?php
											$result_point = 0;
											$content_query = mysqli_query($conn, "select * from employee_result e
											where e.emplo_id = '$get_id' AND e.program_id = 23 order by e.employee_result_id desc limit 1
											") or die(mysqli_error());
											while ($row = mysqli_fetch_array($content_query)) {
												$total_result_point +=$row['result_point'];
												$total_result_wate +=$row['stated'];
								...
								where employee_id ='$get_id'") or die(mysqli_error());
